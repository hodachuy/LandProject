 ...
 */
Hashtable = function(n) {
        function e(n) {
            return typeof n == f ? n : "" + n
        }

        function c(n) {
            var t;
            return typeof n == f ? n : typeof n.hashCode == i ? (t = n.hashCode(), typeof t == f ? t : c(t)) : e(n)
        }
        ...
        function l(t) {
            return function(i) {
                if (i === null) throw new Error("null is not a valid " + t);
                else if (i === n) throw new Error(t + " must not be undefined");
            }
        }
        ...
        function h(n) {
            return function(t) {
                for (var r = this.entries.length, i, u = this.getEqualityFunction(t); r--;)
                    if (i = this.entries[r], u(t, i[0])) switch (n) {
                        case a:
                            return !0;
                        case v:
                            return i;
        ...
        function p(n) {
            return function(t) {
                for (var u = t.length, i = 0, r = this.entries, f = r.length; i < f; ++i) t[u + i] = r[i][n]
            }
        }

        function d(n, t) {
            for (var i = n.length, r; i--;)
                if (r = n[i], t === r[0]) return i;
            return null
        }

        function r(n, t) {
            var i = n[t];
            return i && i instanceof s ? i : null
        }
        ...
        function u() {
            var i = [],
                ...
                a = arguments[1],
                e, v, h;
            a !== n ? (f.hashCode = l, f.equals = a) : l !== n && w(f, l);
            e = f.hashCode;
            v = f.equals;
            this.properties = f;
            this.put = function(n, h) {
                t(n);
                o(h);
                var a = e(n),
                    c, l, y = null;
                return c = r(u, a), c ? (l = c.getEntryForKey(n), l ? (f.replaceDuplicateKey && (l[0] = n), y = l[1], l[1] = h) : c.addEntry(n, h)) : (c = new s(a, n, h, v), i.push(c), u[a] = c), y
            };
            this.get = function(n) {
                var o, i, f;
                return (t(n), o = e(n), i = r(u, o), i && (f = i.getEntryForKey(n), f)) ? f[1] : null
            };
            this.containsKey = function(n) {
                t(n);
                var f = e(n),
                    i = r(u, f);
                return i ? i.containsKey(n) : !1
            };
            this.containsValue = function(n) {
                o(n);
                for (var t = i.length; t--;)
                    if (i[t].containsValue(n)) return !0;
                return !1
            };
            this.clear = function() {
                i.length = 0;
            ...
            h = function(n) {
                return function() {
                    for (var t = [], r = i.length; r--;) i[r][n](t);
                    return t
                }
            };
            this.keys = h("keys");
            ...
            this.remove = function(n) {
                ...
                var f = e(n),
                    h, o = null,
                    s = r(u, f);
                return s && (o = s.removeEntryForKey(n), o !== null && s.entries.length == 0 && (h = d(i, f), i.splice(h, 1), delete u[f])), o
            };
            this.size = function() {
                for (var n = 0, t = i.length; t--;) n += i[t].entries.length;
                return n
            }
        }
        var i = "function",
            f = "string",
            t, o;
        if (typeof encodeURIComponent == "undefined" || Array.prototype.splice === n || Object.prototype.hasOwnProperty === n) return null;
        t = l("key");
        o = l("value");
        var a = 0,
            v = 1,
            y = 2;
        return s.prototype = {
            getEqualityFunction: function(n) {
                return typeof n.equals == i ? b : k
            },
            getEntryForKey: h(v),
            getEntryAndIndexForKey: h(y),
            removeEntryForKey: function(n) {
                var t = this.getEntryAndIndexForKey(n);
                return t ? (this.entries.splice(t[0], 1), t[1]) : null
            },
            ...
            keys: p(0),
            values: p(1),
            getEntries: function(n) {
                for (var r = n.length, t = 0, i = this.entries, u = i.length; t < u; ++t) n[r + t] = i[t].slice(0)
            },
            containsKey: h(a),
            containsValue: function(n) {
                for (var t = this.entries, i = t.length; i--;)
                    if (n === t[i][1]) return !0;
                return !1
            }
        }, u.prototype = {
            each: function(n) {
                for (var i = this.entries(), r = i.length, t; r--;) t = i[r], n(t[0], t[1])
            },
            equals: function(n) {
                var u, t, i, r = this.size();
                if (r == n.size()) {
                    for (u = this.keys(); r--;)
                        if (t = u[r], i = n.get(t), i === null || i !== this.get(t)) return !1;
                    return !0
                }
                return !1
            },
            putAll: function(n, t) {
                for (var e = n.entries(), f, r, u, o, s = e.length, h = typeof t == i; s--;) f = e[s], r = f[0], u = f[1], h && (o = this.get(r)) && (u = t(r, o, u)), this.put(r, u)
            },
            clone: function() {
                var n = new u(this.properties);
                return n.putAll(this), n
            }
        }, u.prototype.toQueryString = function() {
            for (var i = this.entries(), n = i.length, t, r = []; n--;) t = i[n], r[n] = encodeURIComponent(e(t[0])) + "=" + encodeURIComponent(e(t[1]));
            return r.join("&")
        }, u
    }(),
    function(n) {
        ...
        function e() {
            for (var u, i, n = 0; n < r.length; n++)
                for (u = r[n], i = 0; i < u.length; i++) t.put(u[i], n)
        }
        ...
        function i(n, i) {
            ...
            var s = ".",
                h = ",";
            return i == !1 && (n.indexOf("_") != -1 ? n = n.split("_")[1].toLowerCase() : n.indexOf("-") != -1 && (n = n.split("-")[1].toLowerCase())), o = t.get(n), o && (r = u[o], r && (s = r[0], h = r[1])), new f(s, h, "-")
        }
        var t = new Hashtable,
            u = [
                [".", ","],
        ...
        n.fn.formatNumber = function(t, i, r) {
            return this.each(function() {
                var f, u;
                return i == null && (i = !0), r == null && (r = !0), f = n(this).is(":input") ? new String(n(this).val()) : new String(n(this).text()), u = n.formatNumber(f, t), i && (n(this).is(":input") ? n(this).val(u) : n(this).text(u)), r ? u : void 0
            })
        };
        n.formatNumber = function(t, r) {
            for (var f, c, r = n.extend({}, n.fn.formatNumber.defaults, r), o = i(r.locale.toLowerCase(), r.isFullLocale), l = o.dec, a = o.group, v = o.neg, s = "0#-,.", e = "", h = !1, u = 0; u < r.format.length; u++)
                if (s.indexOf(r.format.charAt(u)) == -1) e = e + r.format.charAt(u);
                else if (u == 0 && r.format.charAt(u) == "-") {
                h = !0;
                continue
            } else break;
            for (f = "", u = r.format.length - 1; u >= 0; u--)
                if (s.indexOf(r.format.charAt(u)) == -1) f = r.format.charAt(u) + f;
                else break;
            return r.format = r.format.substring(e.length), r.format = r.format.substring(0, r.format.length - f.length), c = new Number(t), n._formatNumber(c, r, f, e, h)
        };
        n._formatNumber = function(t, r, u, f, e) {
            var r = n.extend({}, n.fn.formatNumber.defaults, r),
                b = i(r.locale.toLowerCase(), r.isFullLocale),
                k = b.dec,
                d = b.group,
                g = b.neg,
                nt, c, v, l, a, ft, et, y, s, h, tt, it, p, o, rt, ot, ut, w;
            if (r.overrideGroupSep != null && (d = r.overrideGroupSep), r.overrideDecSep != null && (k = r.overrideDecSep), r.overrideNegSign != null && (g = r.overrideNegSign), nt = !1, isNaN(t))
                if (r.nanForceZero == !0) t = 0, nt = !0;
                else return "";
            if ((r.isPercentage == !0 || r.autoDetectPercentage && u.charAt(u.length - 1) == "%") && (t = t * 100), c = "", r.format.indexOf(".") > -1) {
                for (v = k, l = r.format.substring(r.format.lastIndexOf(".") + 1), r.round == !0 ? t = new Number(t.toFixed(l.length)) : (a = t.toString(), a.lastIndexOf(".") > 0 && (a = a.substring(0, a.lastIndexOf(".") + l.length + 1)), t = new Number(a)), ft = new Number(t.toString().substring(t.toString().indexOf("."))), decimalString = new String(ft.toFixed(l.length)), decimalString = decimalString.substring(decimalString.lastIndexOf(".") + 1), o = 0; o < l.length; o++)
                    if (l.charAt(o) == "#" && decimalString.charAt(o) != "0") {
                        v += decimalString.charAt(o);
                        continue
                    } else if (l.charAt(o) == "#" && decimalString.charAt(o) == "0")
                    if (et = decimalString.substring(o), et.match("[1-9]")) {
                        v += decimalString.charAt(o);
                        continue
                    } else break;
                else l.charAt(o) == "0" && (v += decimalString.charAt(o));
                c += v
            } else t = Math.round(t);
            if (y = Math.floor(t), t < 0 && (y = Math.ceil(t)), s = "", s = r.format.indexOf(".") == -1 ? r.format : r.format.substring(0, r.format.indexOf(".")), h = "", !(y == 0 && s.substr(s.length - 1) == "#") || nt) {
                for (tt = new String(Math.abs(y)), it = 9999, s.lastIndexOf(",") != -1 && (it = s.length - s.lastIndexOf(",") - 1), p = 0, o = tt.length - 1; o > -1; o--) h = tt.charAt(o) + h, p++, p == it && o != 0 && (h = d + h, p = 0);
                if (s.length > h.length && (rt = s.indexOf("0"), rt != -1))
                    for (ot = s.length - rt, ut = s.length - h.length - 1; h.length < ot;) w = s.charAt(ut), w == "," && (w = d), h = w + h, ut--
            }
            return h || s.indexOf("0", s.length - 1) === -1 || (h = "0"), c = h + c, t < 0 && e && f.length > 0 ? f = g + f : t < 0 && (c = g + c), r.decimalSeparatorAlwaysShown || c.lastIndexOf(k) == c.length - 1 && (c = c.substring(0, c.length - 1)), f + c + u
        };
        n.fn.parseNumber = function(t, i, r) {
            var f, u;
            return i == null && (i = !0), r == null && (r = !0), f = n(this).is(":input") ? new String(n(this).val()) : new String(n(this).text()), u = n.parseNumber(f, t), u && (i && (n(this).is(":input") ? n(this).val(u.toString()) : n(this).text(u.toString())), r) ? u : void 0
        };
        n.parseNumber = function(t, r) {
            var r = n.extend({}, n.fn.parseNumber.defaults, r),
                o = i(r.locale.toLowerCase(), r.isFullLocale),
                a = o.dec,
                s = o.group,
                v = o.neg,
                u, c, f, e, l, y;
            r.overrideGroupSep != null && (s = r.overrideGroupSep);
            r.overrideDecSep != null && (a = r.overrideDecSep);
            r.overrideNegSign != null && (v = r.overrideNegSign);
            for (var h = ".-", p = r.strict; t.indexOf(s) > -1;) t = t.replace(s, "");
            for (t = t.replace(a, ".").replace(v, "-"), u = "", c = !1, (r.isPercentage == !0 || r.autoDetectPercentage && t.charAt(t.length - 1) == "%") && (c = !0), f = 0; f < t.length; f++)
                if ("1234567890".indexOf(t.charAt(f)) > -1) u = u + t.charAt(f);
                else if (h.indexOf(t.charAt(f)) > -1) u = u + t.charAt(f), h = h.replace(t.charAt(f), "");
            else if (r.allowPostfix) break;
            else if (p) {
                u = "NaN";
                break
            }
            return e = new Number(u), c && (e = e / 100, l = u.indexOf("."), l != -1 ? (y = u.length - l - 1, e = e.toFixed(y + 2)) : e = e.toFixed(2)), e
        };
        n.fn.parseNumber.defaults = {
            locale: "us",
        ...
        Number.prototype.toFixed = function(t) {
            return n._roundNumber(this, t)
        };
        n._roundNumber = function(n, t) {
            var u = Math.pow(10, t || 0),
                r = String(Math.round(n * u) / u),
                i;
            if (t > 0)
                for (i = r.indexOf("."), i == -1 ? (r += ".", i = 0) : i = r.length - (i + 1); i < t;) r += "0", i++;
            return r
        }
    }(jQuery);
$(document).ready(function() {
    function g(n) {
        return $("#txtHoTen", n).val() == "" ? ($("#txtHoTen", n).focus(), !1) : $("#txtMobile", n).val() == "" ? ($("#txtMobile", n).focus(), !1) : $.trim($("#txtMobile").val()).length < 6 ? ($("#txtMobile").focus(), !1) : $("#txtEmail", n).val() == "" ? ($("#txtEmail", n).focus(), !1) : _mbndvalidateemail($.trim($("#txtEmail", n).val())) ? !0 : ($("#txtEmail").focus(), !1)
    }

    function nt(n) {
        var t = {
            name: jQuery("#txtHoTen", n).val(),
            tel: jQuery("#txtMobile", n).val(),
            email: jQuery("#txtEmail", n).val(),
            objectId: $(".hidObjectId").text(),
            objectTitle: $(".hidObjectName").text()
        };
        _milanhomeajax = jQuery.post(c + "/furniture/post", t)
    }
    ...
    function tt() {
        $("#moreCity").on("click", function() {
            ...
            $(this).remove();
            t.find(".list-group-item:last-child").after('<a class="row list-group-item" id="miniCity" href="javascript:;"><span class="other-province">Thu gá»n<\/span><\/a>');
            it()
        })
    }

    function it() {
        $("#miniCity").on("click", function() {
            y();
            $(this).remove()
        })
    }
    ...
    function y() {
        if (t.find('.list-group-item:not(".sub-entry")').length > 10) {
            for (var n = 10; n < t.find('.list-group-item:not(".sub-entry")').length; n++) t.find('.list-group-item:not(".sub-entry")').eq(n).addClass("hidden");
            t.find('.list-group-item:not(".sub-entry")').eq(10).after('<a class="row list-group-item" id="moreCity" href="javascript:;"><span class="other-province">CĂ¡c tá»‰nh khĂ¡c<\/span><\/a>');
            tt()
        }
    }
    ...
    function p() {
        var u, i, e, t, o, c, f;
        if (n.projectCarousel && n.projectCarousel.trigger("destroy.owl.carousel"), u = $("#featureProjectNormal"), i = $("#featureProjectCarousel"), u.length != 0) {
            for (u.empty(), i.empty(), e = n.projectColumnIndex, t = 0; t < e.length; t++) {
                for (var r = e[t], s = 1, h = !1; s <= 4;) {
                    if (o = $("#projectItem_" + r + "_" + (t + 1)), c = $("#projectCarouselItem_" + r + "_" + (t + 1)), o.length > 0) {
                        u.append(o.children().clone());
                        i.append(c.children().clone());
                        n.projectColumnIndex[t] = r + 1;
                        h = !0;
                        break
                    }
                    r++;
                ...
                h || (f = null, f = t == 0 ? $("#projectAdItemFirst") : $("#projectAdItem"), u.append(f.children().clone()), i.append(f.children().clone()))
            }
            i.parents("aside").length == 0 && setTimeout(function() {
                i.owlCarousel({
                    nav: !0,
            ...
            setTimeout(p, n.changeInterval)
        }
    }

    function w() {
        var r = $("#featureObjectNormal"),
            u, t, f, e;
        if (r.length != 0) {
            for (r.empty(), u = n.objectColumnIndex, t = 0; t < u.length; t++) {
                for (var i = u[t], o = 1, s = !1; o <= 4;) {
                    if (f = $("#objectItem_" + i + "_" + (t + 1)), f.length > 0) {
                        r.append(f.children().clone());
                        n.objectColumnIndex[t] = i + 1;
                        s = !0;
                        break
                    }
                    i++;
                ...
                s || (e = null, e = t == 0 ? $("#objectAdItemFirst") : $("#objectAdItem"), r.append(e.children().clone()))
            }
            setTimeout(w, n.changeInterval)
        }
    }

    function ut() {
        var n = $("#featureObjectCarousel");
        n.length != 0 && n.parents("aside").length == 0 && setTimeout(function() {
            n.owlCarousel({
                autoplay: !0,
                autoplayTimeout: 3e3,
    ...
    function b() {
        var u, i, e, t, o, c, f;
        if (n.videoCarousel && n.videoCarousel.trigger("destroy.owl.carousel"), u = $("#featureVideoNormal"), i = $("#featureVideoCarousel"), u.length != 0) {
            for (u.empty(), i.empty(), e = n.videoColumnIndex, t = 0; t < e.length; t++) {
                for (var r = e[t], s = 1, h = !1; s <= 4;) {
                    if (o = $("#videoItem_" + r + "_" + (t + 1)), c = $("#videoCarouselItem_" + r + "_" + (t + 1)), o.length > 0) {
                        u.append(o.children().clone());
                        i.append(c.children().clone());
                        n.videoColumnIndex[t] = r + 1;
                        h = !0;
                        break
                    }
                    r++;
                ...
                h || (f = null, f = t == 0 ? $("#videoAdItemFirst") : $("#videoAdItem"), u.append(f.children().clone()), i.append(f.children().clone()))
            }
            i.parents("aside").length == 0 && setTimeout(function() {
                i.owlCarousel({
                    nav: !0,
            ...
            setTimeout(b, n.changeInterval)
        }
    }

    function k() {
        var r = $("#featureBusinessNormal"),
            u, t, f;
        if (r.length != 0) {
            for (r.empty(), u = n.businessColumnIndex, t = 0; t < u.length; t++) {
                for (var i = u[t], e = 1, o = !1; e <= 4;) {
                    if (f = $("#businessItem_" + i + "_" + (t + 1)), f.length > 0) {
                        r.append(f.children().clone());
                        n.businessColumnIndex[t] = i + 1;
                        o = !0;
                        break
                    }
                    i++;
                ...
                o || r.append($("#businessAdItem").children().clone())
            }
            setTimeout(k, n.changeInterval)
        }
    }
    var c, l, a, i, r, t, u, rt, n, h, f, e, o, s;
    if (customizeScreen(), displaySEOTextMobileOnSearchResult(), c = "http://203.113.172.1:8086", l = new MobileDetect(window.navigator.userAgent), l.mobile()) $(".product-item-name").on("click", function() {
        var n = $(this).closest("div");
        $(n).find("input").prop("checked") == !0 ? $(n).find("input").prop("checked", !1) : $(n).find("input").prop("checked", !0)
    });
    $(".countdown").keyup(function() {
        var n = $(this).val().length,
            t = parseInt($(this).attr("maxlength"));
        $("#" + $(this).attr("data-countdownid")).html("(" + n + "/" + t + " kĂ½ tá»±)")
    });
    autosize($(".auto-size"));
    $(".textbox-phone").on("keydown blur change", function(n) {
        if ($.inArray(n.keyCode, [46, 8, 9, 27, 13, 110]) === -1 && (n.keyCode != 65 && n.keyCode != 67 && n.keyCode != 86 && n.keyCode != 88 || n.ctrlKey !== !0) && (!(n.keyCode >= 35) || !(n.keyCode <= 39))) {
            (n.shiftKey || n.keyCode < 48 || n.keyCode > 57) && (n.keyCode < 96 || n.keyCode > 105) && !$.isNumeric(n.key) && n.preventDefault();
            var t = /[^0-9]/g;
            this.value.replace(t, "") != $(this).val() && (this.value = this.value.replace(t, ""))
        }
    });
    $(".AjaxUploaderQueueTable").length == 0 && $("#MainContent_btnNext").attr("disabled", !1);
    $("[id*=btnUpload]").click(function() {
        $("#MainContent_btnNext").attr("disabled", !0)
    });
    a = setInterval(function() {
        $(".AjaxUploaderQueueTable").length == 0 && $("#MainContent_btnNext").attr("disabled", !1);
        $(".AjaxUploaderQueueTable").length > 0 && $("#MainContent_btnNext").attr("disabled", !0)
    }, 500);
    $("[id*=btnUpload]").length == 0 && clearInterval(a);
    i = $(".form-listing-img");
    $("#MainContent_ctlPicture_Uploader1", i).length > 0 && $("#MainContent_btnNext", i).click(function() {
        return $(".panel-picture", i).length == 0 ? (toastr.error("Vui lĂ²ng chá»n Ă­t nháº¥t 1 hĂ¬nh trÆ°á»›c khi Ä‘Äƒng tin", "ThĂ´ng bĂ¡o!"), !1) : !0
    });
    $(".product").closest($("li")).click(function(n) {
        return $(".form-listing-img").length != 0 && $(".panel-picture", i).length == 0 ? (toastr.error("Vui lĂ²ng chá»n Ă­t nháº¥t 1 hĂ¬nh trÆ°á»›c khi Ä‘Äƒng tin", "ThĂ´ng bĂ¡o!"), n.preventDefault(), !1) : !0
    });
    r = $(".form-project-img");
    $("#MainContent_ctlPicture_ctlPicture_Uploader1", r).length > 0 && $("#MainContent_btnNext", r).click(function() {
        return $(".panel-picture", r).length == 0 ? (toastr.error("Vui lĂ²ng chá»n Ă­t nháº¥t 1 hĂ¬nh trÆ°á»›c khi Ä‘Äƒng tin", "ThĂ´ng bĂ¡o!"), !1) : !0
    });
    $(".premium").closest($("li")).click(function(n) {
        return $(".form-project-img").length != 0 && $(".panel-picture", r).length == 0 ? (toastr.error("Vui lĂ²ng chá»n Ă­t nháº¥t 1 hĂ¬nh trÆ°á»›c khi Ä‘Äƒng tin", "ThĂ´ng bĂ¡o!"), n.preventDefault(), !1) : !0
    });
    $("#MainContent_ctlList_ctlFilters_AttGroups_ctl00_3_txtMin_3").on("input", function() {
        $(this).parseNumber({
            format: "#,###",
            locale: "vn"
        });
        ...
        var n, t;
        t = convertPointNumber($(this).val().replace(/[^a-z0-9]/gi, ","));
        n = $(this).parseNumber({
            format: "#,###.00",
            locale: "vn"
        }, !1);
        n < 1e3 ? $(this).closest("div").find("label").html("Từ " + t + " Triệu") : $(this).closest("div").find("label").html("Từ " + n / 1e3 + " Tỷ");
        $("#MainContent_ctlList_ctlFilters_AttGroups_ctl00_3_hidFromPrice_3").val(n)
    });
    $("#MainContent_ctlList_ctlFilters_AttGroups_ctl00_3_txtMax_3").on("input", function() {
        $(this).parseNumber({
            format: "#,###",
            locale: "vn"
        });
        ...
        n < 1e3 ? $(this).closest("div").find("label").html("Đến " + t + " Triệu") : $(this).closest("div").find("label").html("Đến " + n / 1e3 + " Tỷ");
        $("#MainContent_ctlList_ctlFilters_AttGroups_ctl00_3_hidToPrice_3").val(n)
    });
    if ($("#MainContent_ctl01_ctlAttributes_ctl02_txtAttr").keyup(function() {
            $(this).val(convertPointNumber($(this).val().replace(".", ",")))
        }), $("#MainContent_ctl01_ctlAttributes_ctl04_txtAttr").keyup(function() {
            $(this).val(convertPointNumber($(this).val()))
        }), isNaN(DeFormattedMoney($(".hidPrice").text()))) $(".bank-support-subtitle-techcombank").addClass("hidden"), $(".bank-support-description-techcombank").addClass("margin-top-10");
    else {
        var u = DeFormattedMoney($(".hidPrice").text()),
            v = u * (100 - $(".hidPercentPrice").text()) / 100,
            d = u - v;
        $(".hidPricePriceObject").text(u);
        $(".hidPriceTechcombankAllow").text(d);
        $(".bank-support-price-techcombank").text(FormattedMoney(v))
    }
    $(".popupEventTechcombank").off("click").on("click", function() {
        window.open("https://www.techcombank.com.vn/dang-ky-truc-tuyen/dang-ky-vay-von-truc-tuyen-muabannhadat", "_blank")
    });
    $(".popupEventMilanHome").off("click").on("click", function() {
        $.magnificPopup.open({
            items: {
                src: $(".popupMilanHomeArea").html()
            },
            type: "inline",
            callbacks: {
                beforeOpen: function() {
                    this.st.focus = $(window).width() < 700 ? !1 : "#txtHoTen"
                },
                open: function() {
                    $("#hidAdvert").val(100088);
                    $("#btnMilanSent").click(function() {
                        var n = $("#formMilanHome");
                        g(n) && (nt(n), $.magnificPopup.close())
                    })
                }
            }
        })
    });
    t = $("#jump2filter .list-city");
    y();
    isNaN(DeFormattedMoney($(".hidPriceConsultant").text())) || (u = DeFormattedMoney($(".hidPriceConsultant").text()), $(".hidPriceObjectConsultant").text(u));
    ConsultantEvent();
    rt = -1;
    HSBCEvent();
    $(window).on("resize", function() {
        customizeScreen();
        displaySEOTextMobileOnSearchResult()
    });
    n = {
        changeInterval: 1e4,
        projectColumnIndex: [1, 1, 1, 1],
        projectCarousel: null,
        objectColumnIndex: [1, 1, 1, 1],
        objectCarousel: null,
        videoColumnIndex: [1, 1, 1, 1],
        videoCarousel: null,
        businessColumnIndex: [1, 1, 1, 1]
    };
    h = $("#carousel-home").width();
    $(".carousel-inner img").attr("height", h / 1.78);
    $(".carousel-inner iframe").attr("width", h);
    $(".carousel-inner iframe").attr("height", h / 1.78);
    f = Math.floor(Math.random() * 3 + 1);
    n.projectColumnIndex = [f, f, f, f];
    e = Math.floor(Math.random() * 3 + 1);
    n.objectColumnIndex = [e, e, e, e];
    o = Math.floor(Math.random() * 3 + 1);
    n.videoColumnIndex = [o, o, o, o];
    s = Math.floor(Math.random() * 3 + 1);
    n.businessColumnIndex = [s, s, s, s];
    p();
    w();
    ut();
    b();
    k();
    $(document).ready(function() {
        var n = Math.floor(Math.random() * $("div.item").length);
        $('li[data-slide-to="' + n + '"]').eq(n).addClass("active");
