function actingButton(n){return processing||$(n).hasClass("disabled")?!0:(processing=!0,$(n).attr("data-originhtml",$(n).html()).prop("disabled",!0).html("Processing..."),!1)}function reloadButton(n,t){processing=!1;$(n).html($(n).attr("data-originhtml")).prop("disabled",!1);t&&$(n).addClass("disabled")}function showLoading(){$("body").addClass("loading")}function hideLoading(){$("body").removeClass("loading")}function showAlert(n){$("#alert-modal-body").html(n);$("#alert-modal").modal()}function showMessage(n,t,i){var r=window.parent.$("#global-message"),u;t?r.removeClass("success"):r.addClass("success");r.html((i==undefined?"":"<div>"+i+"<\/div>")+n);u=window.parent.$(window).width()/2-r.width()/2;r.css("left",u+"px").hide().slideDown()}function hideMessage(){$("#global-message").empty().slideUp()}function eventError(){$(".error").closest(".form-group").find("input").bind("input",function(){$(".error").remove()})}function searchUser(){$(".modal").modal("hide");$(".error").remove();$("#searchusermodal").modal("show");fillUsers()}function fillUsers(){var n="";$("#listUser table .item-key").each(function(){n+=n==""?$(this).attr("attr-id"):";"+$(this).attr("attr-id")});$("#Users").val(n)}function delUserItem(n){$(n).closest("tr").remove();fillUsers()}function addItemUser(n,t){var i="<tr><td class='item-key' attr-id='"+n+"'>"+t+"<\/td><td><a href='javascript:;' onclick='delUserItem($(this))'><i class='glyphicon glyphicon-remove'><\/i> Delete<\/a><\/td><\/tr>";$("#listUser table tr:last").after(i);$("#searchitem"+n).remove();fillUsers()}function loadUser(n,t){var r=$(t,n).button("loading"),i=$(".pagination a.current",n).html();typeof i=="undefined"&&(i=1);$.ajax({url:"/promotion/loaddatauser",type:"GET",data:{page:i,size:10,search:$("#txtSearchUser",n).val()},datatype:"json",contentType:"application/json; charset=utf-8",success:function(t){if(t.length!=0){$(".search-user-result",n).empty().append(t);var i=[];$(".item-key").each(function(n,t){i.push($(t).attr("attr-id"))});i.forEach(function(n){$("#searchitem"+n).remove()})}r.button("reset");loadUserEvent(n)}})}function loadUserEvent(n){$(".pagination a",n).off("click").on("click",function(){$("a.current",n).removeClass("current");$(this).addClass("current");loadUser(n,$("#btnSearchUser",n))})}function DocSo3ChuSo(n){var u,t,r,i="";if(u=parseInt(n/100),t=parseInt(n%100/10),r=n%10,u==0&&t==0&&r==0)return"";u!=0&&(i+=ChuSo[u]+" trÄƒm ",t==0&&r!=0&&(i+=" linh "));t!=0&&t!=1&&(i+=ChuSo[t]+" mÆ°Æ¡i",t==0&&r!=0&&(i=i+" linh "));t==1&&(i+=" mÆ°á»i ");switch(r){case 1:i+=t!=0&&t!=1?" má»‘t ":ChuSo[r];break;case 5:i+=t==0?ChuSo[r]:" lÄƒm ";break;default:r!=0&&(i+=ChuSo[r])}return i}function DocTienBangChu(n){var e=0,u=0,i=0,r="",f="",t=[];if(n<0)return"Sá»‘ tiá»n Ă¢m !";if(n==0)return"";if(i=n>0?n:-n,n>8999999999999999)return"Sá»‘ quĂ¡ lá»›n!";for(t[5]=Math.floor(i/1e15),isNaN(t[5])&&(t[5]="0"),i=i-parseFloat(t[5].toString())*1e15,t[4]=Math.floor(i/1e12),isNaN(t[4])&&(t[4]="0"),i=i-parseFloat(t[4].toString())*1e12,t[3]=Math.floor(i/1e9),isNaN(t[3])&&(t[3]="0"),i=i-parseFloat(t[3].toString())*1e9,t[2]=parseInt(i/1e6),isNaN(t[2])&&(t[2]="0"),t[1]=parseInt(i%1e6/1e3),isNaN(t[1])&&(t[1]="0"),t[0]=parseInt(i%1e3),isNaN(t[0])&&(t[0]="0"),e=t[5]>0?5:t[4]>0?4:t[3]>0?3:t[2]>0?2:t[1]>0?1:0,u=e;u>=0;u--)f=DocSo3ChuSo(t[u]),r+=f,t[u]>0&&(r+=Tien[u]),u>0&&f.length>0&&(r+=",");return r.substring(r.length-1)==","&&(r=r.substring(0,r.length-1)),r=r.substring(1,2).toUpperCase()+r.substring(2),r+" Ä‘á»“ng"}function DeFormattedMoney(n){return n.toLowerCase().indexOf("tá»·")>=0?(n.split(" ")[0].replace(",",".")*1e9).toFixed(2):(n.split(" ")[0].replace(",",".")*1e6).toFixed(2)}function FormattedMoney(n){return n>=1e9?(n/1e9+" tá»·").replace(".",","):(n/1e6+" triá»‡u").replace(".",",")}function _mbndvalidateemail(n){return/^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/.test(n)}function isValidMobileNumber(n){return n==null||n.length<10||n.length>16?!1:!0}function convertPointNumber(n){var t,i;return(n.match(/,/g)||[]).length==1&&(t=n.split(",")[1],n=t.length>2?n.split(",")[0]+","+t.slice(0,-1):n.split(",")[0]+","+t),(n.match(/,/g)||[]).length>1&&(i=n.slice(-1),i==","&&(n=n.slice(0,-1))),n}function HitAdvert(n){CallService("/Services/Tracking/a"+n+"/HitAdvert")}function HitCategory(n){CallService("/Services/Tracking/c"+n+"/HitCategory")}function GetPhone(n){CallService("/Services/Tracking/a"+n+"/GetPhone",null,".phonefield")}function GetCompanyPhone(n){CallService("/Services/Tracking/cmp"+n+"/GetCompanyPhone",null,".phonefield")}function SendShareEvent(n,t){var i="";t=="facebook"?i="click facebook share button":t=="google"&&(i="click googleplus share button");ga&&ga("send","event","share",i,window.location.href,0,{nonInteraction:!0})}function CallService(n,t,i){var r=t||{};$.ajax({type:"POST",url:n,data:r,success:function(n){i&&$(i).html(n)},error:function(){i&&$(i).html("Unavailable")}})}function showphone(n,t,i){$(n).removeAttr("onclick");i=="detail"&&ga?ga("send","event","leads","click show phone number listing",$(".hidPrimaryCategoryName").text(),0,{nonInteraction:!0}):i=="sticky"&&ga&&ga("send","event","click to call","click to call sticky listing",t,0,{nonInteraction:!0});CallServiceCustom("/Services/Tracking/a"+t+"/GetPhoneCustom",null,".btn-action-showphone",t)}function showbusinessphone(n,t,i){if(n){var r=$(n).attr("data-phoneext");typeof r!=typeof undefined&&r!==!1?(ga&&ga("send","event","leads","click show phone number business",i,0,{nonInteraction:!0}),$(n).html($(n).html().replace("xxx",$(n).attr("data-phoneext"))),$(".clicktoviewphone").remove(),isMobile()&&$(n).attr("href","tel:"+$(n).attr("data-phone")),$(n).removeAttr("data-phoneext").removeAttr("data-phone")):ga&&ga("send","event","click to call","click to call business",i,0,{nonInteraction:!0})}}function isMobile(){var n=!1;return(/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|ipad|iris|kindle|Android|Silk|lge |maemo|midp|mmp|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino/i.test(navigator.userAgent)||/1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i.test(navigator.userAgent.substr(0,4)))&&(n=!0),n}function CallServiceCustom(n,t,i){var r=$(i).attr("data-phoneext"),u;typeof r!=typeof undefined&&r!==!1&&(u=t||{},$.ajax({type:"POST",url:n,data:u,success:function(n){if(i){var t=i;$(t).html("<div class='icon img-call spacer-right-5'><\/div>"+n);$(".clicktoviewphone").remove();$(i).removeAttr("data-phoneext").removeAttr("data-phone")}},error:function(){i&&$(i).html("Unavailable")}}))}function clickToCall(n,t){t=="detail"&&ga&&ga("send","event","click to call","click to call listing",n,1,{nonInteraction:!0})}function ShowSendToFriendBox(){var n=document.getElementById("Send2FriendBox").style.display;n=="none"?$("#Send2FriendBox").slideDown(100):$("#Send2FriendBox").slideUp(100)}function ShowPhoneNumber(n,t,i){var r="#"+i.id,u="Services/Tracking/cmp"+n+"/GetCompanyPhone",f=r;CallService(u,{},f)}function ChangeMainImage(n){$(".img-gallery-main").attr("src",n)}function submitForm(n,t){$(n).prop("disabled",!0).text("Äang xá»­ lĂ½...");__doPostBack(t,"")}function customsa(){$(window).width()<768&&$(".customsa").attr("style","display: block;height: 100%;")}function setCookieFeaturedObject(){var n=new Date;n.setTime(n.getTime()+6e4);$.cookie("featuredObject","1",{expires:n})}function setCookieFeaturedVideoObject(){var n=new Date;n.setTime(n.getTime()+6e4);$.cookie("featuredVideoObject","1",{expires:n})}function customizeScreen(){var n,t;$(window).width()<768?(n=$(".hsbc-area").remove().clone(!0),t=$(".consultant-area").remove().clone(!0),$(".showMobileHSBC").html(n),$(".showMobileConsultant").html(t),ConsultantEvent(),HSBCEvent()):(n=$(".hsbc-area").remove().clone(!0),t=$(".consultant-area").remove().clone(!0),$(".showDesktopHSBC").html(n),$(".showDesktopConsultant").html(t),ConsultantEvent(),HSBCEvent())}function HSBCEvent(){$("input[data-number]").blur(function(){var n=$(this).val().replace(/\./g,""),t=parseFloat(n).formatMoney(0);$(this).val(n==""||n==$(this).attr("placeholder").replace(/,/g,"")?"":t)});$("#btn-mortgage-calc").off("click").on("click",function(){hsbcvalidateinput()&&(hsbccalculate(),$.magnificPopup.open({items:{src:$(".popup-mortgage-area").html()},type:"inline",callbacks:{beforeOpen:function(){$(window).width()<700&&(this.st.focus=!1)},open:function(){var t=Math.floor(Date.now()/1e3),n;$.ajax({dataType:"image/gif",url:"http://bs.serving-sys.com/BurstingPipe/adServer.bs?cn=tf&c=19&mc=imp&pli=14261210&PluID=0&ord="+t+"&rtu=-1",type:"GET",error:function(n,t,i){console.log("error",n,t,i)}});n=parseFloat(hsbcamount).formatMoney(0);$(".hsbc-result").text(n);$("#btn-register-mortgage").click(function(){$.magnificPopup.close();window.open("http://oceanbank.vn/ngan-hang-ca-nhan/chi-tiet/3986/cho-vay-san-xuat-kinh-doanh-khach-hang-ban-le.html","_blank")})}}}))})}function hsbcvalidateinput(){clearVal();var n=$("#txtThunhap").val().replace(/\./g,"");return n==""||isNaN(n)?($("#txtThunhap").focus(),$("#txtThunhap").after('<label class="errorLabel">Thu nháº­p khĂ´ng Ä‘á»ƒ trá»‘ng.<\/label>'),!1):(n=$("#txtKhoanvay").val().replace(/\./g,""),isNaN(n))?($("#txtKhoanvay").focus(),!1):(n=$("#txtHanmuc").val().replace(/\./g,""),isNaN(n))?($("#txtHanmuc").focus(),!1):(n=$("#txtThoihan").val().replace(/\./g,""),n==""||isNaN(n))?($("#txtThoihan").focus(),$("#txtThoihan").after('<label class="errorLabel">Thá»i háº¡n vay khĂ´ng Ä‘á»ƒ trá»‘ng.<\/label>'),!1):!0}function hsbccalculate(){var n,i,r,o=parseFloat($("#txtThunhap").val().replace(/\./g,"")),u,f,e,t;r=$("#txtKhoanvay").val()==""?0:parseFloat($("#txtKhoanvay").val().replace(/\./g,""));n=$("#txtHanmuc").val()==""?0:parseFloat($("#txtHanmuc").val().replace(/\./g,""));u=parseFloat($("#txtThoihan").val().replace(/\./g,""));f=9.5;i=n<2e7?50:n>2e7&&n<5e7?60:70;e=i/100*o-r-.05*n;t=hsbcpv(f,12,u,e,0);t<=0&&(t=0);hsbcamount=parseFloat(t)}function hsbcpv(n,t,i,r,u){var f;return(i=parseFloat(i),r=parseFloat(r),u=parseFloat(u),n=eval(n/(t*100)),r==0||i==0)?0:(n==0?f=u+r*i:(x=Math.pow(1+n,-i),y=Math.pow(1+n,i),f=x*(u*n-r+y*r)/n),hsbcconvertnumber(f,0))}function hsbcconvertnumber(n,t){for(var i=""+Math.round(eval(n)*Math.pow(10,t)),r;i.length<=t;)i="0"+i;return r=i.length-t,i.substring(0,r)+"."+i.substring(r,i.length)}function ConsultantEvent(){$("#btnConsultantvaluation").click(function(){var n=$("#formConsultant");consultantvaluationvalidate(n)&&($("#Modal-consultant",n).modal("show"),_consultantvaluationsave(n),$('input[type="text"]',n).val(""))})}function consultantvaluationvalidate(n){return(clearVal(),$("#txtName",n).val()=="")?($("#txtName",n).focus(),$("#txtName",n).after('<label class="errorLabel">Vui lĂ²ng nháº­p tĂªn.<\/label>'),!1):$("#txtMobile",n).val()==""?($("#txtMobile",n).focus(),$("#txtMobile",n).after('<label class="errorLabel">Vui lĂ²ng nháº­p Ä‘iá»‡n thoáº¡i.<\/label>'),!1):$.trim($("#txtMobile").val()).length<6?($("#txtMobile").focus(),$("#txtMobile",n).after('<label class="errorLabel">Sai Ä‘á»‹nh dáº¡ng Ä‘iá»‡n thoáº¡i.<\/label>'),!1):$("#txtEmail",n).val()==""?($("#txtEmail",n).focus(),$("#txtEmail",n).after('<label class="errorLabel">Vui lĂ²ng nháº­p Email.<\/label>'),!1):_mbndvalidateemail($.trim($("#txtEmail",n).val()))?!0:($("#txtEmail").focus(),$("#txtEmail",n).after('<label class="errorLabel">Sai Ä‘á»‹nh dáº¡ng Email.<\/label>'),!1)}function _consultantvaluationsave(n){var t={name:jQuery("#txtName",n).val(),tel:jQuery("#txtMobile",n).val(),email:jQuery("#txtEmail",n).val(),objectId:$(".hidObjectId").text(),objectTitle:$(".hidObjectName").text(),priceObject:$(".hidPriceObjectConsultant").text(),link:window.location.href,emailcustomer:"toan.ttb@sivc.com.vn,thovsivc@sivc.com.vn"};_consultantvaluationajax=jQuery.post(posturl+"/consultantvaluation/post",t)}function clearVal(){$("input").removeClass("errorClass");$("select").removeClass("errorClass");$(".errorLabel").remove()}function displaySEOTextMobileOnSearchResult(){$(window).width()<768?$("#MainContent_ctlList_teaser").remove().clone().insertAfter("#jump2filter"):$("#MainContent_ctlList_teaser").remove().clone().insertAfter(".result-list")}var MBND_CONFIGS={newsleterAPI:"https://crm.muabannhadat.vn/mbndlib/sailthru/app/apiNewsletter.php",CRMSecret:"00150e9e69e7846b646cc9f4f0e2930a",posturlfastRegister:"https://crm.muabannhadat.vn/mbndApi.php?mbndrequest=crmRegisterNewsletter",Grab_SourceId:"z9fp3iyH1p",Grab_SourceCampainName:"muabannhadat",Grab_SourceAppName:"muabannhadat.vn",Grab_ScreenType:"BOOKING",Grab_PickupKeyword:""},COMMON,processing,ChuSo,Tien,Hashtable;
/*!
 ...
 */
(function(n,t,i){function f(n){return n}function e(n){return decodeURIComponent(n.replace(u," "))}var u=/\+/g,r=n.cookie=function(u,o,s){var y,w,c,l,h,p,a,v;if(o!==i)return s=n.extend({},r.defaults,s),o===null&&(s.expires=-1),typeof s.expires=="number"&&(y=s.expires,w=s.expires=new Date((new Date).getTime()+y*6e4)),o=r.json?JSON.stringify(o):String(o),t.cookie=[encodeURIComponent(u),"=",r.raw?o:encodeURIComponent(o),s.expires?"; expires="+s.expires.toUTCString():"",s.path?"; path="+s.path:"",s.domain?"; domain="+s.domain:"",s.secure?"; secure":""].join("");for(c=r.raw?f:e,l=t.cookie.split("; "),h=0,p=l.length;h<p;h++)if(a=l[h].split("="),c(a.shift())===u)return v=c(a.join("=")),r.json?JSON.parse(v):v;return null};r.defaults={};n.removeCookie=function(t,i){return n.cookie(t)!==null?(n.cookie(t,null,i),!0):!1}})(jQuery,document);
/*!
 ...
 */
Hashtable=function(n){function e(n){return typeof n==f?n:""+n}function c(n){var t;return typeof n==f?n:typeof n.hashCode==i?(t=n.hashCode(),typeof t==f?t:c(t)):e(n)}function w(n,t){for(var i in t)t.hasOwnProperty(i)&&(n[i]=t[i])}function b(n,t){return n.equals(t)}function k(n,t){return typeof t.equals==i?t.equals(n):n===t}function l(t){return function(i){if(i===null)throw new Error("null is not a valid "+t);else if(i===n)throw new Error(t+" must not be undefined");}}function s(n,t,i,r){this[0]=n;this.entries=[];this.addEntry(t,i);r!==null&&(this.getEqualityFunction=function(){return r})}function h(n){return function(t){for(var r=this.entries.length,i,u=this.getEqualityFunction(t);r--;)if(i=this.entries[r],u(t,i[0]))switch(n){case a:return!0;case v:return i;case y:return[r,i[1]]}return!1}}function p(n){return function(t){for(var u=t.length,i=0,r=this.entries,f=r.length;i<f;++i)t[u+i]=r[i][n]}}function d(n,t){for(var i=n.length,r;i--;)if(r=n[i],t===r[0])return i;return null}function r(n,t){var i=n[t];return i&&i instanceof s?i:null}function u(){var i=[],u={},f={replaceDuplicateKey:!0,hashCode:c,equals:null},l=arguments[0],a=arguments[1],e,v,h;a!==n?(f.hashCode=l,f.equals=a):l!==n&&w(f,l);e=f.hashCode;v=f.equals;this.properties=f;this.put=function(n,h){t(n);o(h);var a=e(n),c,l,y=null;return c=r(u,a),c?(l=c.getEntryForKey(n),l?(f.replaceDuplicateKey&&(l[0]=n),y=l[1],l[1]=h):c.addEntry(n,h)):(c=new s(a,n,h,v),i.push(c),u[a]=c),y};this.get=function(n){var o,i,f;return(t(n),o=e(n),i=r(u,o),i&&(f=i.getEntryForKey(n),f))?f[1]:null};this.containsKey=function(n){t(n);var f=e(n),i=r(u,f);return i?i.containsKey(n):!1};this.containsValue=function(n){o(n);for(var t=i.length;t--;)if(i[t].containsValue(n))return!0;return!1};this.clear=function(){i.length=0;u={}};this.isEmpty=function(){return!i.length};h=function(n){return function(){for(var t=[],r=i.length;r--;)i[r][n](t);return t}};this.keys=h("keys");this.values=h("values");this.entries=h("getEntries");this.remove=function(n){t(n);var f=e(n),h,o=null,s=r(u,f);return s&&(o=s.removeEntryForKey(n),o!==null&&s.entries.length==0&&(h=d(i,f),i.splice(h,1),delete u[f])),o};this.size=function(){for(var n=0,t=i.length;t--;)n+=i[t].entries.length;return n}}var i="function",f="string",t,o;if(typeof encodeURIComponent=="undefined"||Array.prototype.splice===n||Object.prototype.hasOwnProperty===n)return null;t=l("key");o=l("value");var a=0,v=1,y=2;return s.prototype={getEqualityFunction:function(n){return typeof n.equals==i?b:k},getEntryForKey:h(v),getEntryAndIndexForKey:h(y),removeEntryForKey:function(n){var t=this.getEntryAndIndexForKey(n);return t?(this.entries.splice(t[0],1),t[1]):null},addEntry:function(n,t){this.entries.push([n,t])},keys:p(0),values:p(1),getEntries:function(n){for(var r=n.length,t=0,i=this.entries,u=i.length;t<u;++t)n[r+t]=i[t].slice(0)},containsKey:h(a),containsValue:function(n){for(var t=this.entries,i=t.length;i--;)if(n===t[i][1])return!0;return!1}},u.prototype={each:function(n){for(var i=this.entries(),r=i.length,t;r--;)t=i[r],n(t[0],t[1])},equals:function(n){var u,t,i,r=this.size();if(r==n.size()){for(u=this.keys();r--;)if(t=u[r],i=n.get(t),i===null||i!==this.get(t))return!1;return!0}return!1},putAll:function(n,t){for(var e=n.entries(),f,r,u,o,s=e.length,h=typeof t==i;s--;)f=e[s],r=f[0],u=f[1],h&&(o=this.get(r))&&(u=t(r,o,u)),this.put(r,u)},clone:function(){var n=new u(this.properties);return n.putAll(this),n}},u.prototype.toQueryString=function(){for(var i=this.entries(),n=i.length,t,r=[];n--;)t=i[n],r[n]=encodeURIComponent(e(t[0]))+"="+encodeURIComponent(e(t[1]));return r.join("&")},u}(),function(n){function f(n,t,i){this.dec=n;this.group=t;this.neg=i}function e(){for(var u,i,n=0;n<r.length;n++)for(u=r[n],i=0;i<u.length;i++)t.put(u[i],n)}function i(n,i){var o,r;t.size()==0&&e();var s=".",h=",";return i==!1&&(n.indexOf("_")!=-1?n=n.split("_")[1].toLowerCase():n.indexOf("-")!=-1&&(n=n.split("-")[1].toLowerCase())),o=t.get(n),o&&(r=u[o],r&&(s=r[0],h=r[1])),new f(s,h,"-")}var t=new Hashtable,u=[[".",","],[",","."],[","," "],[".","'"]],r=[["ae","au","ca","cn","eg","gb","hk","il","in","jp","sk","th","tw","us"],["at","br","de","dk","es","gr","it","nl","pt","tr","vn"],["bg","cz","fi","fr","no","pl","ru","se"],["ch"]];n.fn.formatNumber=function(t,i,r){return this.each(function(){var f,u;return i==null&&(i=!0),r==null&&(r=!0),f=n(this).is(":input")?new String(n(this).val()):new String(n(this).text()),u=n.formatNumber(f,t),i&&(n(this).is(":input")?n(this).val(u):n(this).text(u)),r?u:void 0})};n.formatNumber=function(t,r){for(var f,c,r=n.extend({},n.fn.formatNumber.defaults,r),o=i(r.locale.toLowerCase(),r.isFullLocale),l=o.dec,a=o.group,v=o.neg,s="0#-,.",e="",h=!1,u=0;u<r.format.length;u++)if(s.indexOf(r.format.charAt(u))==-1)e=e+r.format.charAt(u);else if(u==0&&r.format.charAt(u)=="-"){h=!0;continue}else break;for(f="",u=r.format.length-1;u>=0;u--)if(s.indexOf(r.format.charAt(u))==-1)f=r.format.charAt(u)+f;else break;return r.format=r.format.substring(e.length),r.format=r.format.substring(0,r.format.length-f.length),c=new Number(t),n._formatNumber(c,r,f,e,h)};n._formatNumber=function(t,r,u,f,e){var r=n.extend({},n.fn.formatNumber.defaults,r),b=i(r.locale.toLowerCase(),r.isFullLocale),k=b.dec,d=b.group,g=b.neg,nt,c,v,l,a,ft,et,y,s,h,tt,it,p,o,rt,ot,ut,w;if(r.overrideGroupSep!=null&&(d=r.overrideGroupSep),r.overrideDecSep!=null&&(k=r.overrideDecSep),r.overrideNegSign!=null&&(g=r.overrideNegSign),nt=!1,isNaN(t))if(r.nanForceZero==!0)t=0,nt=!0;else return"";if((r.isPercentage==!0||r.autoDetectPercentage&&u.charAt(u.length-1)=="%")&&(t=t*100),c="",r.format.indexOf(".")>-1){for(v=k,l=r.format.substring(r.format.lastIndexOf(".")+1),r.round==!0?t=new Number(t.toFixed(l.length)):(a=t.toString(),a.lastIndexOf(".")>0&&(a=a.substring(0,a.lastIndexOf(".")+l.length+1)),t=new Number(a)),ft=new Number(t.toString().substring(t.toString().indexOf("."))),decimalString=new String(ft.toFixed(l.length)),decimalString=decimalString.substring(decimalString.lastIndexOf(".")+1),o=0;o<l.length;o++)if(l.charAt(o)=="#"&&decimalString.charAt(o)!="0"){v+=decimalString.charAt(o);continue}else if(l.charAt(o)=="#"&&decimalString.charAt(o)=="0")if(et=decimalString.substring(o),et.match("[1-9]")){v+=decimalString.charAt(o);continue}else break;else l.charAt(o)=="0"&&(v+=decimalString.charAt(o));c+=v}else t=Math.round(t);if(y=Math.floor(t),t<0&&(y=Math.ceil(t)),s="",s=r.format.indexOf(".")==-1?r.format:r.format.substring(0,r.format.indexOf(".")),h="",!(y==0&&s.substr(s.length-1)=="#")||nt){for(tt=new String(Math.abs(y)),it=9999,s.lastIndexOf(",")!=-1&&(it=s.length-s.lastIndexOf(",")-1),p=0,o=tt.length-1;o>-1;o--)h=tt.charAt(o)+h,p++,p==it&&o!=0&&(h=d+h,p=0);if(s.length>h.length&&(rt=s.indexOf("0"),rt!=-1))for(ot=s.length-rt,ut=s.length-h.length-1;h.length<ot;)w=s.charAt(ut),w==","&&(w=d),h=w+h,ut--}return h||s.indexOf("0",s.length-1)===-1||(h="0"),c=h+c,t<0&&e&&f.length>0?f=g+f:t<0&&(c=g+c),r.decimalSeparatorAlwaysShown||c.lastIndexOf(k)==c.length-1&&(c=c.substring(0,c.length-1)),f+c+u};n.fn.parseNumber=function(t,i,r){var f,u;return i==null&&(i=!0),r==null&&(r=!0),f=n(this).is(":input")?new String(n(this).val()):new String(n(this).text()),u=n.parseNumber(f,t),u&&(i&&(n(this).is(":input")?n(this).val(u.toString()):n(this).text(u.toString())),r)?u:void 0};n.parseNumber=function(t,r){var r=n.extend({},n.fn.parseNumber.defaults,r),o=i(r.locale.toLowerCase(),r.isFullLocale),a=o.dec,s=o.group,v=o.neg,u,c,f,e,l,y;r.overrideGroupSep!=null&&(s=r.overrideGroupSep);r.overrideDecSep!=null&&(a=r.overrideDecSep);r.overrideNegSign!=null&&(v=r.overrideNegSign);for(var h=".-",p=r.strict;t.indexOf(s)>-1;)t=t.replace(s,"");for(t=t.replace(a,".").replace(v,"-"),u="",c=!1,(r.isPercentage==!0||r.autoDetectPercentage&&t.charAt(t.length-1)=="%")&&(c=!0),f=0;f<t.length;f++)if("1234567890".indexOf(t.charAt(f))>-1)u=u+t.charAt(f);else if(h.indexOf(t.charAt(f))>-1)u=u+t.charAt(f),h=h.replace(t.charAt(f),"");else if(r.allowPostfix)break;else if(p){u="NaN";break}return e=new Number(u),c&&(e=e/100,l=u.indexOf("."),l!=-1?(y=u.length-l-1,e=e.toFixed(y+2)):e=e.toFixed(2)),e};n.fn.parseNumber.defaults={locale:"us",decimalSeparatorAlwaysShown:!1,isPercentage:!1,autoDetectPercentage:!0,isFullLocale:!1,strict:!1,overrideGroupSep:null,overrideDecSep:null,overrideNegSign:null,allowPostfix:!1};n.fn.formatNumber.defaults={format:"#,###.00",locale:"us",decimalSeparatorAlwaysShown:!1,nanForceZero:!0,round:!0,isFullLocale:!1,overrideGroupSep:null,overrideDecSep:null,overrideNegSign:null,isPercentage:!1,autoDetectPercentage:!0};Number.prototype.toFixed=function(t){return n._roundNumber(this,t)};n._roundNumber=function(n,t){var u=Math.pow(10,t||0),r=String(Math.round(n*u)/u),i;if(t>0)for(i=r.indexOf("."),i==-1?(r+=".",i=0):i=r.length-(i+1);i<t;)r+="0",i++;return r}}(jQuery);$(document).ready(function(){function g(n){return $("#txtHoTen",n).val()==""?($("#txtHoTen",n).focus(),!1):$("#txtMobile",n).val()==""?($("#txtMobile",n).focus(),!1):$.trim($("#txtMobile").val()).length<6?($("#txtMobile").focus(),!1):$("#txtEmail",n).val()==""?($("#txtEmail",n).focus(),!1):_mbndvalidateemail($.trim($("#txtEmail",n).val()))?!0:($("#txtEmail").focus(),!1)}function nt(n){var t={name:jQuery("#txtHoTen",n).val(),tel:jQuery("#txtMobile",n).val(),email:jQuery("#txtEmail",n).val(),objectId:$(".hidObjectId").text(),objectTitle:$(".hidObjectName").text()};_milanhomeajax=jQuery.post(c+"/furniture/post",t)}function tt(){$("#moreCity").on("click",function(){t.find(".hidden").removeClass("hidden");$(this).remove();t.find(".list-group-item:last-child").after('<a class="row list-group-item" id="miniCity" href="javascript:;"><span class="other-province">Thu gá»n<\/span><\/a>');it()})}function it(){$("#miniCity").on("click",function(){y();$(this).remove()})}function y(){if(t.find('.list-group-item:not(".sub-entry")').length>10){for(var n=10;n<t.find('.list-group-item:not(".sub-entry")').length;n++)t.find('.list-group-item:not(".sub-entry")').eq(n).addClass("hidden");t.find('.list-group-item:not(".sub-entry")').eq(10).after('<a class="row list-group-item" id="moreCity" href="javascript:;"><span class="other-province">CĂ¡c tá»‰nh khĂ¡c<\/span><\/a>');tt()}}function p(){var u,i,e,t,o,c,f;if(n.projectCarousel&&n.projectCarousel.trigger("destroy.owl.carousel"),u=$("#featureProjectNormal"),i=$("#featureProjectCarousel"),u.length!=0){for(u.empty(),i.empty(),e=n.projectColumnIndex,t=0;t<e.length;t++){for(var r=e[t],s=1,h=!1;s<=4;){if(o=$("#projectItem_"+r+"_"+(t+1)),c=$("#projectCarouselItem_"+r+"_"+(t+1)),o.length>0){u.append(o.children().clone());i.append(c.children().clone());n.projectColumnIndex[t]=r+1;h=!0;break}r++;r>4&&(r=1);s++}h||(f=null,f=t==0?$("#projectAdItemFirst"):$("#projectAdItem"),u.append(f.children().clone()),i.append(f.children().clone()))}i.parents("aside").length==0&&setTimeout(function(){i.owlCarousel({nav:!0,navText:['<i class="glyphicon glyphicon-chevron-left"><\/i>','<i class="glyphicon glyphicon-chevron-right"><\/i>'],loop:!0,center:!0,responsive:{0:{items:1.081},479:{items:1.081},768:{items:2.081},980:{items:2.081},1199:{items:4}}});n.projectCarousel=i},0);setTimeout(p,n.changeInterval)}}function w(){var r=$("#featureObjectNormal"),u,t,f,e;if(r.length!=0){for(r.empty(),u=n.objectColumnIndex,t=0;t<u.length;t++){for(var i=u[t],o=1,s=!1;o<=4;){if(f=$("#objectItem_"+i+"_"+(t+1)),f.length>0){r.append(f.children().clone());n.objectColumnIndex[t]=i+1;s=!0;break}i++;i>4&&(i=1);o++}s||(e=null,e=t==0?$("#objectAdItemFirst"):$("#objectAdItem"),r.append(e.children().clone()))}setTimeout(w,n.changeInterval)}}function ut(){var n=$("#featureObjectCarousel");n.length!=0&&n.parents("aside").length==0&&setTimeout(function(){n.owlCarousel({autoplay:!0,autoplayTimeout:3e3,autoplayHoverPause:!0,nav:!0,navText:['<i class="glyphicon glyphicon-chevron-left"><\/i>','<i class="glyphicon glyphicon-chevron-right"><\/i>'],loop:!0,center:!0,responsive:{0:{items:1.081},479:{items:1.081},768:{items:2.081},980:{items:2.081},1199:{items:4}}})},0)}function b(){var u,i,e,t,o,c,f;if(n.videoCarousel&&n.videoCarousel.trigger("destroy.owl.carousel"),u=$("#featureVideoNormal"),i=$("#featureVideoCarousel"),u.length!=0){for(u.empty(),i.empty(),e=n.videoColumnIndex,t=0;t<e.length;t++){for(var r=e[t],s=1,h=!1;s<=4;){if(o=$("#videoItem_"+r+"_"+(t+1)),c=$("#videoCarouselItem_"+r+"_"+(t+1)),o.length>0){u.append(o.children().clone());i.append(c.children().clone());n.videoColumnIndex[t]=r+1;h=!0;break}r++;r>4&&(r=1);s++}h||(f=null,f=t==0?$("#videoAdItemFirst"):$("#videoAdItem"),u.append(f.children().clone()),i.append(f.children().clone()))}i.parents("aside").length==0&&setTimeout(function(){i.owlCarousel({nav:!0,navText:['<i class="glyphicon glyphicon-chevron-left"><\/i>','<i class="glyphicon glyphicon-chevron-right"><\/i>'],loop:!0,center:!0,responsive:{0:{items:1.081},479:{items:1.081},768:{items:2.081},980:{items:2.081},1199:{items:4}}});n.videoCarousel=i},0);setTimeout(b,n.changeInterval)}}function k(){var r=$("#featureBusinessNormal"),u,t,f;if(r.length!=0){for(r.empty(),u=n.businessColumnIndex,t=0;t<u.length;t++){for(var i=u[t],e=1,o=!1;e<=4;){if(f=$("#businessItem_"+i+"_"+(t+1)),f.length>0){r.append(f.children().clone());n.businessColumnIndex[t]=i+1;o=!0;break}i++;i>4&&(i=1);e++}o||r.append($("#businessAdItem").children().clone())}setTimeout(k,n.changeInterval)}}var c,l,a,i,r,t,u,rt,n,h,f,e,o,s;if(customizeScreen(),displaySEOTextMobileOnSearchResult(),c="http://203.113.172.1:8086",l=new MobileDetect(window.navigator.userAgent),l.mobile())$(".product-item-name").on("click",function(){var n=$(this).closest("div");$(n).find("input").prop("checked")==!0?$(n).find("input").prop("checked",!1):$(n).find("input").prop("checked",!0)});$(".countdown").keyup(function(){var n=$(this).val().length,t=parseInt($(this).attr("maxlength"));$("#"+$(this).attr("data-countdownid")).html("("+n+"/"+t+" kĂ½ tá»±)")});autosize($(".auto-size"));$(".textbox-phone").on("keydown blur change",function(n){if($.inArray(n.keyCode,[46,8,9,27,13,110])===-1&&(n.keyCode!=65&&n.keyCode!=67&&n.keyCode!=86&&n.keyCode!=88||n.ctrlKey!==!0)&&(!(n.keyCode>=35)||!(n.keyCode<=39))){(n.shiftKey||n.keyCode<48||n.keyCode>57)&&(n.keyCode<96||n.keyCode>105)&&!$.isNumeric(n.key)&&n.preventDefault();var t=/[^0-9]/g;this.value.replace(t,"")!=$(this).val()&&(this.value=this.value.replace(t,""))}});$(".AjaxUploaderQueueTable").length==0&&$("#MainContent_btnNext").attr("disabled",!1);$("[id*=btnUpload]").click(function(){$("#MainContent_btnNext").attr("disabled",!0)});a=setInterval(function(){$(".AjaxUploaderQueueTable").length==0&&$("#MainContent_btnNext").attr("disabled",!1);$(".AjaxUploaderQueueTable").length>0&&$("#MainContent_btnNext").attr("disabled",!0)},500);$("[id*=btnUpload]").length==0&&clearInterval(a);i=$(".form-listing-img");$("#MainContent_ctlPicture_Uploader1",i).length>0&&$("#MainContent_btnNext",i).click(function(){return $(".panel-picture",i).length==0?(toastr.error("Vui lĂ²ng chá»n Ă­t nháº¥t 1 hĂ¬nh trÆ°á»›c khi Ä‘Äƒng tin","ThĂ´ng bĂ¡o!"),!1):!0});$(".product").closest($("li")).click(function(n){return $(".form-listing-img").length!=0&&$(".panel-picture",i).length==0?(toastr.error("Vui lĂ²ng chá»n Ă­t nháº¥t 1 hĂ¬nh trÆ°á»›c khi Ä‘Äƒng tin","ThĂ´ng bĂ¡o!"),n.preventDefault(),!1):!0});r=$(".form-project-img");$("#MainContent_ctlPicture_ctlPicture_Uploader1",r).length>0&&$("#MainContent_btnNext",r).click(function(){return $(".panel-picture",r).length==0?(toastr.error("Vui lĂ²ng chá»n Ă­t nháº¥t 1 hĂ¬nh trÆ°á»›c khi Ä‘Äƒng tin","ThĂ´ng bĂ¡o!"),!1):!0});$(".premium").closest($("li")).click(function(n){return $(".form-project-img").length!=0&&$(".panel-picture",r).length==0?(toastr.error("Vui lĂ²ng chá»n Ă­t nháº¥t 1 hĂ¬nh trÆ°á»›c khi Ä‘Äƒng tin","ThĂ´ng bĂ¡o!"),n.preventDefault(),!1):!0});$("#MainContent_ctlList_ctlFilters_AttGroups_ctl00_3_txtMin_3").on("input",function(){$(this).parseNumber({format:"#,###",locale:"vn"});$(this).formatNumber({format:"#,###",locale:"vn"});var n,t;t=convertPointNumber($(this).val().replace(/[^a-z0-9]/gi,","));n=$(this).parseNumber({format:"#,###.00",locale:"vn"},!1);n<1e3?$(this).closest("div").find("label").html("Tá»« "+t+" Triá»‡u"):$(this).closest("div").find("label").html("Tá»« "+n/1e3+" Tá»·");$("#MainContent_ctlList_ctlFilters_AttGroups_ctl00_3_hidFromPrice_3").val(n)});$("#MainContent_ctlList_ctlFilters_AttGroups_ctl00_3_txtMax_3").on("input",function(){$(this).parseNumber({format:"#,###",locale:"vn"});$(this).formatNumber({format:"#,###",locale:"vn"});var n,t;t=convertPointNumber($(this).val().replace(/[^a-z0-9]/gi,","));n=$(this).parseNumber({format:"#,###.00",locale:"vn"},!1);n<1e3?$(this).closest("div").find("label").html("Ä‘áº¿n "+t+" Triá»‡u"):$(this).closest("div").find("label").html("Ä‘áº¿n "+n/1e3+" Tá»·");$("#MainContent_ctlList_ctlFilters_AttGroups_ctl00_3_hidToPrice_3").val(n)});if($("#MainContent_ctl01_ctlAttributes_ctl02_txtAttr").keyup(function(){$(this).val(convertPointNumber($(this).val().replace(".",",")))}),$("#MainContent_ctl01_ctlAttributes_ctl04_txtAttr").keyup(function(){$(this).val(convertPointNumber($(this).val()))}),isNaN(DeFormattedMoney($(".hidPrice").text())))$(".bank-support-subtitle-techcombank").addClass("hidden"),$(".bank-support-description-techcombank").addClass("margin-top-10");else{var u=DeFormattedMoney($(".hidPrice").text()),v=u*(100-$(".hidPercentPrice").text())/100,d=u-v;$(".hidPricePriceObject").text(u);$(".hidPriceTechcombankAllow").text(d);$(".bank-support-price-techcombank").text(FormattedMoney(v))}$(".popupEventTechcombank").off("click").on("click",function(){window.open("https://www.techcombank.com.vn/dang-ky-truc-tuyen/dang-ky-vay-von-truc-tuyen-muabannhadat","_blank")});$(".popupEventMilanHome").off("click").on("click",function(){$.magnificPopup.open({items:{src:$(".popupMilanHomeArea").html()},type:"inline",callbacks:{beforeOpen:function(){this.st.focus=$(window).width()<700?!1:"#txtHoTen"},open:function(){$("#hidAdvert").val(100088);$("#btnMilanSent").click(function(){var n=$("#formMilanHome");g(n)&&(nt(n),$.magnificPopup.close())})}}})});t=$("#jump2filter .list-city");y();isNaN(DeFormattedMoney($(".hidPriceConsultant").text()))||(u=DeFormattedMoney($(".hidPriceConsultant").text()),$(".hidPriceObjectConsultant").text(u));ConsultantEvent();rt=-1;HSBCEvent();$(window).on("resize",function(){customizeScreen();displaySEOTextMobileOnSearchResult()});n={changeInterval:1e4,projectColumnIndex:[1,1,1,1],projectCarousel:null,objectColumnIndex:[1,1,1,1],objectCarousel:null,videoColumnIndex:[1,1,1,1],videoCarousel:null,businessColumnIndex:[1,1,1,1]};h=$("#carousel-home").width();$(".carousel-inner img").attr("height",h/1.78);$(".carousel-inner iframe").attr("width",h);$(".carousel-inner iframe").attr("height",h/1.78);f=Math.floor(Math.random()*3+1);n.projectColumnIndex=[f,f,f,f];e=Math.floor(Math.random()*3+1);n.objectColumnIndex=[e,e,e,e];o=Math.floor(Math.random()*3+1);n.videoColumnIndex=[o,o,o,o];s=Math.floor(Math.random()*3+1);n.businessColumnIndex=[s,s,s,s];p();w();ut();b();k();$(document).ready(function(){var n=Math.floor(Math.random()*$("div.item").length);$('li[data-slide-to="'+n+'"]').eq(n).addClass("active");$("div.item").eq(n).addClass("active");$("#carousel-home").show()});jQuery(document).ready(function(n){n(window).scroll(function(){var r=n(window).scrollTop(),t,i;n(".contact-seller").length>0&&(t=n(".contact-seller").offset().top,i=t-r,i<30?(n(".cussticky").css("position","fixed").css("top","0").removeClass("navbar-fixed-top").addClass("navbar-fixed-top").css("padding-top","70px"),n(".cussticky").removeClass("hidden")):(n(".cussticky").css("position","static").removeClass("navbar-fixed-top").css("padding-top","0px"),n(".cussticky").addClass("hidden")))})});$(document).ready(function(n){n(window).scroll(function(){var r=n(window).scrollTop(),t,i;n(".contact-areantt").length>0&&(t=n(".contact-areantt").offset().top,i=t-r,i<30?(n(".cussticky").css("position","fixed").css("top","0").removeClass("navbar-fixed-top").addClass("navbar-fixed-top").css("padding-top","70px"),n(".cussticky").removeClass("hidden")):(n(".cussticky").css("position","static").removeClass("navbar-fixed-top").css("padding-top","0px"),n(".cussticky").addClass("hidden")))})});$(document).ready(function(n){n(window).width()<=1200?n(".cussnewLayou").removeClass("hidden"):n(".cussnewLayou").addClass("hidden");n(window).resize(function(){var t=n("#carousel-home").width();n(window).width()<=1200?(n(".cussnewLayou").removeClass("hidden"),n(".carousel-inner img").attr("height",t/1.78),n(".carousel-inner iframe").attr("width",t),n(".carousel-inner iframe").attr("height",t/1.78)):(n(".carousel-inner img").attr("height",300),n(".carousel-inner iframe").attr("width",535),n(".carousel-inner iframe").attr("height",300),n(".cussnewLayou").addClass("hidden"))})})});
